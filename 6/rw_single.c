...
void process(ctx_t* ctx, int rank, int comm_size) {
    ...
    particle_t* tmp_left = (particle_t*) malloc(tmp_left_max_size * sizeof(particle_t));
    particle_t* tmp_right = (particle_t*) malloc(tmp_right_max_size * sizeof(particle_t));
    particle_t* tmp_up = (particle_t*) malloc(tmp_up_max_size * sizeof(particle_t));
    particle_t* tmp_down = (particle_t*) malloc(tmp_down_max_size * sizeof(particle_t));
